# Sticht Leerlingmonitor

De Sticht Leerlingmonitor (voorheen SchoolMonitor) helpt de scholen van Het Sticht om de profielen van hun leerlingen bij te houden, met de ondersteuningsniveaus van ZOUT.

Hier staan de nieuwste versies:

- **Sticht Leerlingmonitor.html**: voor scholen. Nieuw schooljaar, bijwerken (een groep erbij of een nieuwe versie van het sjabloon), een nieuwe school, en de gegevens voor Het Sticht.
- **Sticht Leerlingmonitor Totaaloverzicht.html**: voor Het Sticht. Maakt één overzicht van alle scholen samen.
- **Sticht Leerlingmonitor Zo zet je het klaar.pdf**: zo zet je het op je computer.
